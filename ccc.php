...
<head>
    ...
    <style>
    .jumbotron {
    background: url("additionals/images/ccc1.webp") no-repeat center center; 
   ...
   ?>
    ...
    <div class="container my-4">
        <div class="jumbotron jumbotron-fluid">
            <div class="container text-light">
                <h1 class="display-4 mx-2 text-center text-dark"><b>C/C++/C#</b></h1>
                <p class="lead my-2">This is the place where you will get to know more about C/C++/C#. Ask the query and
                    community will
    ...
    $noresult = false;
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $cc_title = $_POST['cctitle'];
        $cc_desc  = $_POST['ccdesc'];

        require "additionals/_dbconnect.php";

        $sql1 ="INSERT INTO `ccc` ( `cc_title`, `cc_desc`, `cc_date`) 
        VALUES ( ' $cc_title', ' $cc_desc', current_timestamp());";
    ...
    <div class="container">
        <form action="<?php echo $_SERVER['REQUEST_URI']?>"method="post">
            <div class="form-group">
                <label for="cctitile">Question Title</label>
                <input type="textarea" class="form-control" id="cctitle" name="cctitle" aria-describedby="emailHelp"
                    placeholder="question title">

            </div>
            <div class="form-group">
                <label for="ccdesc">Example textarea</label>
                <textarea class="form-control" id="ccdesc" name="ccdesc" rows="3"></textarea>
            </div>
    ...
    <div class="container">
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            <h5 class="mt-0" ><a class="" href="c-ans.php?catid='.$id.'">'.$title.'</a></h5>
