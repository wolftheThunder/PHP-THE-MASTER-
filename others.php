...
<head>
    ...
    <style> 
    .jumbotron {
    background: url("additionals/images/others.png") no-repeat center center; 
   ...
   ?>
    ...
    <div class="container my-4">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4 mx-2 text-center"><b>Others</b></h1>
                <p class="lead my-2">This is the place where you will get to know more about Others. Ask the query and
                    community will
    ...
    $noresult = false;
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql1 ="INSERT INTO `questions` ( `q_title`, `q_desc`, `q_date`) 
        VALUES ( '$q_title', '$q_desc ', current_timestamp());";
    ...
    <div class="container">
        <form action="<?php echo $_SERVER['REQUEST_URI']?>"method="post">
            <div class="form-group">
                <label for="qtitile">Question Title</label>
                <input type="textarea" class="form-control" id="qtitle" name="qtitle" aria-describedby="emailHelp"
                    placeholder="question title">

            </div>
            <div class="form-group">
                <label for="qdesc">Example textarea</label>
                <textarea class="form-control" id="qdesc" name="qdesc" rows="3"></textarea>
            </div>
