...
<body>
    ...
    require "additionals/_navbar.php";
     $id = $_GET['catid'];
        ...
        $sql1 ="SELECT * FROM `ccc` where cc_id=$id";
    ...
    <?php
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $ca_desc  = $_POST['ca_title'];
        require "additionals/_dbconnect.php";

        $sql1 ="INSERT INTO `ca` ( `ca_title`, `ca_cat_id`, `ca_date`)
         VALUES (' $ca_desc', '$id', current_timestamp());";
    ...
    <div class="container">
        <form action="<?php echo $_SERVER['REQUEST_URI']?>" method="post"?> 
            ...
            <div class="form-group">
                <label for="ca_title">Answer to this question</label>
                <textarea class="form-control" id="ca_title" name="ca_title" rows="3"></textarea>
            </div>
    ...
    <?php
        $id = $_GET['catid'];
        require "additionals/_dbconnect.php";
        $sql4 ="SELECT * FROM `ca` WHERE ca_cat_id=$id;";
