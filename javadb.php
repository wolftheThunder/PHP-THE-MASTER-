...
<head>
    ...
    <style>
    .jumbotron {
    background: url("additionals/images/java.jpg") no-repeat center center; 
  ...
  ?>
    ...
    <div class="container my-4">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4 mx-2 text-center"><b>Java</b></h1>
                <p class="lead my-2">This is the place where you will get to know more about Java. Ask the query and
                    community will
    ...
    $noresult = false;
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $j_title = $_POST['ptitle'];
        $j_desc  = $_POST['pdesc'];

        require "additionals/_dbconnect.php";

        $sql1 ="INSERT INTO `java` (`j_title`, `j_desc`, `j_date`) 
        VALUES ('  $j_title ', ' $j_desc ', current_timestamp());";
    ...
    <div class="container">
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            <h5 class="mt-0" ><a class="" href="j-answers.php?catid='.$id.'">'.$title.'</a></h5>
