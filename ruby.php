...
<head>
    ...
    <style> 
    .jumbotron {
    background: url("additionals/images/ruby.png") no-repeat center center; 
...
<body>
    ...
    <div class="container my-4">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4 mx-2 text-center"><b>Ruby</b></h1>
                <p class="lead my-2">This is the place where you will get to know more about Ruby. Ask the query and
                    community will
    ...
    $noresult = false;
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $r_title = $_POST['rtitle'];
        $r_desc  = $_POST['rdesc'];

        require "additionals/_dbconnect.php";

        $sql1 ="INSERT INTO `ruby` (`r_title`, `r_desc`, `r_date`)
         VALUES ( '$r_title', '$r_desc', current_timestamp());";
    ...
    <div class="container">
        <form action="<?php echo $_SERVER['REQUEST_URI']?>"method="post">
            <div class="form-group">
                <label for="rtitle">Question Title</label>
                <input type="textarea" class="form-control" id="rtitle" name="rtitle" aria-describedby="emailHelp"
                    placeholder="question title">

            </div>
            <div class="form-group">
                <label for="rdesc">Example textarea</label>
                <textarea class="form-control" id="rdesc" name="rdesc" rows="3"></textarea>
            </div>
    ...
    <div class="container">
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            <h5 class="mt-0" ><a class="" href="r-ans.php?catid='.$id.'">'.$title.'</a></h5>
