...
<body>
    ...
    require "additionals/_navbar.php";
     $id = $_GET['catid'];
        ...
        $sql1 ="SELECT * FROM `ruby` where r_id=$id";
    ...
    <?php
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $ra_desc  = $_POST['radesc'];
        require "additionals/_dbconnect.php";

        $sql1 ="INSERT INTO `ruby-ans` ( `ra_desc`, `ra_cat_id`, `ra_date`) 
        VALUES ( ' $ra_desc', '$id', current_timestamp());";
    ...
    <div class="container">
        <form action="<?php echo $_SERVER['REQUEST_URI']?>" method="post"?> 
            ...
            <div class="form-group">
                <label for="radesc">Answer to this question</label>
                <textarea class="form-control" id="radesc" name="radesc" rows="3"></textarea>
            </div>
    ...
    <?php
        $id = $_GET['catid'];
        require "additionals/_dbconnect.php";
        $sql4 ="SELECT * FROM `ruby-ans` WHERE ra_cat_id=$id;";
