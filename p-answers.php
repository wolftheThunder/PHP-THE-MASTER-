...
<body>
    ...
    require "additionals/_navbar.php";
     $id = $_GET['catid'];
        ...
        $sql1 ="SELECT * FROM `pyhton` where p_id=$id";
    ...
    <?php
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $pa_desc  = $_POST['padesc'];
        require "additionals/_dbconnect.php";

        $sql1 ="INSERT INTO `python-ans` ( `pa_desc`, `pa_date`, `p_cat_id`) 
        VALUES ( '$pa_desc', current_timestamp(), '$id');";
    ...
    <?php
        $id = $_GET['catid'];
        require "additionals/_dbconnect.php";
        $sql4 ="SELECT * FROM `python-ans` WHERE p_cat_id=$id;";
