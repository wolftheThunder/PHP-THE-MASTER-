   ...
   ?>
    ...
    <?php
     if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $qa_desc  = $_POST['qadesc'];
        require "additionals/_dbconnect.php";

        $sql1 ="INSERT INTO `q_answers` (`qa_desc`, `qa_cat_id`, `qa_date`) 
        VALUES ( '$qa_desc', '$id', current_timestamp());";
    ...
    <div class="container">
        <form action="<?php echo $_SERVER['REQUEST_URI']?>" method="post"?> 
            ...
            <div class="form-group">
                <label for="qadesc">Answer to this question</label>
                <textarea class="form-control" id="qadesc" name="qadesc" rows="3"></textarea>
            </div>
    ...
    <?php
        $id = $_GET['catid'];
        require "additionals/_dbconnect.php";
        $sql4 ="SELECT * FROM `q_answers` WHERE qa_cat_id=$id;";
